...
import { CiCalendar } from "../../icons/CiCalendar";
import { FluentNote28Regular } from "../../icons/FluentNote28Regular";
import { LucideLayoutDashboard } from "../../icons/LucideLayoutDashboard";
import "./style.css";
      ...
      <div className="div">
        ...
        <div className="iconamoon-search-wrapper">
          <img
            ...
            src="https://c.animaapp.com/ICzxPs25/img/iconamoon-search-bold.svg"
          />
        </div>
      </div>
    </div>
